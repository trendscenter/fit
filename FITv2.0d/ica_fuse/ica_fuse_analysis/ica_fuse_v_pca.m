function [V, Lambda, V_orig, Lambda_orig] = ica_fuse_v_pca(data, firstEig, lastEig, saveEig, doTranspose, removeMean)
...
if (saveEig == 3),
    ...
    covarianceMatrix = ica_fuse_cov(data, rmMean);
...
Lambda = ica_fuse_v_selcol(ica_fuse_v_selcol(Lambda, selectedColumns)',selectedColumns);
