function [correlationValue, timecourse, b, ModelIndices] = ica_fuse_correlateFunctions(modelTimecourse, timecourse, num_DataSets, diffTimePoints, ...
    detrendNumber)
...
if exist('detrendNumber', 'var')
    [rSquare_stat, b, ModelIndices, otherIndices, linearRegress, removeTrend, timecourse, modelX] = ica_fuse_multipleRegression(modelTimecourse, timecourse, 1, num_DataSets, numTimePoints, detrendNumber);
else
    [rSquare_stat, b, ModelIndices, otherIndices, linearRegress, removeTrend, timecourse, modelX] = ica_fuse_multipleRegression(modelTimecourse, timecourse, 1, num_DataSets, numTimePoints);
end
