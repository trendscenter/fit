function [newVectors, whiteningMatrix, dewhiteningMatrix] = ica_fuse_v_whiten(data, V, Lambda, doTranspose);
% [newVectors, whiteningMatrix, dewhiteningMatrix] = ica_fuse_v_whiten(data, V, Lambda);
