function [sR] = ica_fuse_icassoEst(mode, X, M, varargin)
...
for i=1:M,
    ...
    switch mode
        ...
        case {'bootstrap','both'}
            ...
            % PCA
            [V, Lambda] = ica_fuse_v_pca(X_, 1, numOfPC, 0, 'transpose', 'no');
            
            % whiten matrix
            [w, White, deWhite] = ica_fuse_v_whiten(X_, V, Lambda, 'transpose');
    ...
    [icaAlgo, W_, A_] = ica_fuse_icaAlgorithm(algoIndex, w, icaOptions);
