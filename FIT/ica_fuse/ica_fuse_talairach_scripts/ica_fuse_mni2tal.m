function outpoints = ica_fuse_mni2tal(inpoints)
...
upT = ica_fuse_spm_matrix([0 0 0 0.05 0 0 0.99 0.97 0.92]);
downT = ica_fuse_spm_matrix([0 0 0 0.05 0 0 0.99 0.97 0.84]);
