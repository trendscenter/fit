function [W, cost, shapePass, isi, iter] = ica_fuse_iva_ggd(X,varargin)
% [W,cost,shapePass,isi] = ica_fuse_iva_ggd(X,varargin)
%
...
% W=iva_ggd(X)
%
% To test code call function with no input arguments: iva_ggd
%
% Coded by Matthew Anderson (matt.anderson at umbc.edu)
%
% References:
%
% [1] M. Anderson, G.-S. Fu, R. Phlypo, & T. Adali, "Independent Vector Analysis: Identification Conditions and Performance Bounds," IEEE Transactions on Signal Processing, 2014, 62, 4399-4410
% [2] T. Adali, M. Anderson, & G.-S. Fu, "Diversity in Independent Component and Vector Analyses: Identifiability, algorithms, and applications in medical imaging," IEEE Signal Processing Magazine, 2014, 31, 18-33
% [3] T. Adali, Y. Levin-Schwartz, & V. D. Calhoun, "Multi-modal data fusion using source separation: Two effective models based on ICA and IVA and their properties," Proceedings of the IEEE, 2015, 103, 1478-1493
% [4] T. Adali, Y. Levin-Schwartz, & V. D. Calhoun, "Multi-modal data fusion using source separation: Application to medical imaging," Proceedings of the IEEE, 2015, 103, 1494-1506
% [5] Y. Levin-Schwartz, V. D. Calhoun, & T. Adali, "Two Models for Fusion of Medical Imaging Data: Comparisons and Connection 2017," IEEE International Conference on Acoustics, Speech, and Signal Processing (ICASSP), 2017
...
function test_iva_ggd
%% built-in test function for iva_ggd
disp('Executing internal test function for iva_ggd.')
