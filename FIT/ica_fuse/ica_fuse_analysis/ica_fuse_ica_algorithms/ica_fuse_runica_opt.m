...
function [weights,sphere,activations,bias,signs,lrates,y] = ica_fuse_runica_opt(data,p1,v1,p2,v2,p3,v3,p4,v4,p5,v5,p6,v6,p7,v7,p8,v8,p9,v9,p10,v10,p11,v11,p12,v12,p13,v13,p14,v14)
...
%                      end
      ...
      while change < DEFAULT_PECOMPUTE & strcmp(logisticflag,'on')   
             ...
             gnum = 0;
              ...
              for i=1:chans
                  name =ica_fuse_optimal5fun(Esignal1(i,:));        % Using the transformed signal: Esignal1
