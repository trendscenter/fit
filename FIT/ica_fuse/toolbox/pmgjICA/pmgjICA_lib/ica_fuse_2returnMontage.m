function [im, numImagesX, numImagesY, slices_in_mm] = ica_fuse_2returnMontage(images, compIndex, DIM, VOX, slices_in_mm)
...
%[im(:,:) numImagesX numImagesY] = ica_fuse_get_montage(temp, structHInfo.VOX);
[im(:,:) numImagesX numImagesY] = ica_fuse_2get_montage(temp, VOX);