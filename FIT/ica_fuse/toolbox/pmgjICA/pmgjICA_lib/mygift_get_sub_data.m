function [data_sets, numOfSub, numOfSess, selected_data_sets, data_folders] = mygift_get_sub_data(sourceDir, filePattern, ...
    flagFolder, verbose)
...
chk_var=class(sourceDir);
if (isa(chk_var, 'char') || isa(chk_var, 'struct'))
