function [icasig] = ica_fuse_2applyDispParameters(icasig, convertToZ, returnValue, threshValue, ...
    structDIM, HInfo)
...
if isa(icasig, 'complex_data')
    ...
    for ii = 1:length(fieldNames)
        ...
        currentData = ica_fuse_2applyDispParameters_comp(currentData, convertToZ, returnValue, threshValue, ...
        structDIM, HInfo);
...
elseif isreal(icasig)
    ...
    [icasig] = ica_fuse_2applyDispParameters_comp(icasig, convertToZ, returnValue, threshValue, ...
        structDIM, HInfo);
