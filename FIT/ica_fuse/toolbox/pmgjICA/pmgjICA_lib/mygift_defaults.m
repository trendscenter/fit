...
% Missing subjects in mancovan (cutoff in percentage): for example analysis is not done at a partcular voxel, frequency bin
...
%% DESPIKE METHOD 
% Option 1 - Uses afni based despiking method. Optionally c vector can be
% specified like [c1, c2]. Text is taken from afni 3d despike.
...
DESPIKE_OPTIONS.solver = 'lsqcurvefit';
