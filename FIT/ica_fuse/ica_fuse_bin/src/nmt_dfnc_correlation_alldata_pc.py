...
'''
import os
os.environ["THEANO_FLAGS"] = "device=cpu,floatX=float32,gpuarray.preallocate=1,blas.ldflags=-L'C:\\Users\\Srinivas\\Anaconda2\\Library\\bin' -lmkl_core -lmkl_intel_thread -lmkl_rt"
