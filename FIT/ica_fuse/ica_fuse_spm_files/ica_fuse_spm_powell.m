function [p,f] = ica_fuse_spm_powell(p,xi,tolsc,func,varargin)
% Powell optimisation method
% FORMAT [p,f] = ica_fuse_spm_powell(p,xi,tolsc,func,varargin)
...
% John Ashburner
% $Id: ica_fuse_spm_powell.m 7112 2017-06-16 11:30:37Z guillaume $
...
%--------------------------------------------------------------------------
%fg = ica_fuse_spm_figure('FindWin','Interactive');
fg=[];
