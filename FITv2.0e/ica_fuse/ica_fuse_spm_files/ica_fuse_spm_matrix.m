function [A] = ica_fuse_spm_matrix(P, order)
% returns an affine transformation matrix
% FORMAT [A] = ica_fuse_spm_matrix(P, order)
% P(1)  - x translation
% P(2)  - y translation
% P(3)  - z translation
...
%
% ica_fuse_spm_matrix returns a matrix defining an orthogonal linear (translation,
...
% 4) translation
%
% This order can be changed by calling ica_fuse_spm_matrix with a string as a
...
% Karl Friston
% $Id: ica_fuse_spm_matrix.m 1149 2008-02-14 14:29:04Z volkmar $
