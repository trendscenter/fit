function ica_fuse_spm_check_orientations(V)
% Check the dimensions and orientations of the images
% FORMAT ica_fuse_spm_check_orientations(V)
%
% V - a structure as returned by ica_fuse_spm_vol.
%_______________________________________________________________________
% Copyright (C) 2008 Wellcome Trust Centre for Neuroimaging

% John Ashburner
% $Id: ica_fuse_spm_check_orientations.m 1143 2008-02-07 19:33:33Z spm $
