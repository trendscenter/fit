function ica_fuse_write_nifti_data(outputFileName, V, data, description)
...
ni         = ica_fuse_nifti;
ni.dat     = ica_fuse_file_array(outputFileName, [V(1).dim size(data, 4)], 'INT16-BE', 0, sf, 0);
ni.mat     = N(1).mat;
ni.mat0    = N(1).mat;
...
for i = 1:size(ni.dat, 4)
    ni.dat(:, :, :, i) = data(:, :, :, i);
    ica_fuse_spm_get_space([ni.dat.fname ',' num2str(i)], V(i).mat);
end
