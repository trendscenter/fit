...
%% PGICA-ICA defaults
% voxels >= multiplier*mean
PGICA_ICA_DEFAULTS.mask.smri_mult = 0.01; % smri Multiplier
PGICA_ICA_DEFAULTS.mask.smri_threshold = 0.7; % Average Mask threshold for smri
PGICA_ICA_DEFAULTS.mask.smri_corr_threshold = 0.8;% Correlation threshold to remove outiler subjects
...
GREY_MATTER = which('gmmask.nii');
WHITE_MATTER = which('wmmask.nii');
