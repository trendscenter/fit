...
% Modality selection
inputText(numParameters).promptString = 'Select Modality?';
...
paramsH = ica_fuse_plot_controls_fig(inputText, 'DataSelect', 'on', 'Done', 'Cancel', 1);
...
files = ica_fuse_selectEntry('typeEntity', 'file', 'typeSelection', 'multiple', 'title', ['Select all subjects for ', titleStr], 'filter', '*.nii');
