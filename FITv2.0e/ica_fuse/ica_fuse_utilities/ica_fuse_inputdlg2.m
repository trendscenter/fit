function Answer = ica_fuse_inputdlg2(Prompt, Title, NumLines, DefAns,Resize)
...
FigColor = FIG_BG_COLOR; % use from ica_fuse_defaults
TextForeground = FIG_FG_COLOR; %Black;
...
BtnFontSize = UI_FONT_SIZE; % get from ica_fuse_defaults
...
EdInfo=StInfo;
EdInfo.Style='edit';
EdInfo.BackgroundColor= UI_BG_COLOR; %White;
