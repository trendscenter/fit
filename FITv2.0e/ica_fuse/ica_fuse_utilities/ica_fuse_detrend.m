function [y] = ica_fuse_detrend(y, num_DataSets, diffTimePoints, detrendNumber)
% performs detrending based on the detrend number selected
% in ica_fuse_defaults file selected
%
    ...
    case 0
        ...
        for nDataSets = 1:num_DataSets
            ...
            for nColumns = 1:size(y, 2)
                % solve beta coeff
                b(nTerms*(nDataSets - 1) + (1:nTerms), nColumns) = ica_fuse_regress(y(rowStart:rowEnd, nColumns), X);
