function [contrastResults, con_table] = ica_fuse_anova_contrasts(anovaResults, terms, all_contrasts, contrast_sources, tail)
...
%% P value
pval = ica_fuse_get_pvalue(tval, erdf, tail);
...
if (length(terms) == 1)
    ...
    pval = 1 - ica_fuse_spm_Fcdf(Fstat, degrees_freedom, erdf);
