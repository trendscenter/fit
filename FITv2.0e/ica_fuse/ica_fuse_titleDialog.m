...
text('units', 'normalized', 'string', 'FITv2.0e', 'position', titlePos, 'fontsize', subtitleFont, 'HorizontalAlignment', 'center', ...
...
% authors
fusionInfo = {'', '', ['\bfRelease Date: \rm', num2str('21-Jan-2020')], '', char('\bfAuthors: \rm\bf The FIT Development Team'), ...
